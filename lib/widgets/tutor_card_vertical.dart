...
class TutorCardVertical extends StatefulWidget {
  const TutorCardVertical({super.key});

  @override
  State<TutorCardVertical> createState() => _TutorCardVerticalState();
}

class _TutorCardVerticalState extends State<TutorCardVertical> {
